...
urlpatterns = [
    ...
    path('apple-touch-icon-144x144.png', serve,
         {'path': 'images/apple-touch-icon-144x144.png.png', 'document_root': settings.STATIC_ROOT}),
    path('apple-touch-icon-152x152.png', serve,
         {'path': 'images/apple-touch-icon-152x152.png.png', 'document_root': settings.STATIC_ROOT}),
