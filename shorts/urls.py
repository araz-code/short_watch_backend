...
from shorts.views import ShortedStockView, ShortSellerView, ShortHistoricView
...
router.register('watch/historic', ShortHistoricView)
router.register('pick/historic', ShortHistoricView)
...
router.register('test/watch/historic', ShortHistoricView)
router.register('test/pick/historic', ShortHistoricView)
