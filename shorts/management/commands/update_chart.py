...
from shorts.models import ShortPosition, RunStatus, LargeShortSelling, ShortPositionChart
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        unique_codes = ShortPosition.objects.values('code').distinct()
    ...
    def get_closest_value_to_date(self, target_date, code):
        ...
        closest_record = ShortPosition.objects.filter(code=code,
