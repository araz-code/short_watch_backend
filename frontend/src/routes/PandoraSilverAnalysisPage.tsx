...
// ─── static data ────────────────────────────────────────────────────────────
// Pandora (PNDORA.CO) månedlige lukkekurser i DKK + sølvpris (SI=F) USD/oz.
// Kilder: Yahoo Finance, LBMA.
...
const PandoraSilverAnalysisPage: React.FC = () => {
  ...
  return (
    <PageTemplate>
      ...
      <meta name="description" content="Analyse af sammenhængen mellem sølvprisen, amerikansk forbrugertillid og Pandora-aktiens kursudvikling. Fra 930 DKK i januar 2024 til 556 DKK i maj 2026, mens sølvprisen mere end tredobledes." />
      <meta property="og:title" content="Pandora og sølvprisen: Hvordan råvarer og forbrugertillid påvirker aktien" />
      <meta property="og:description" content="Analyse af sammenhængen mellem sølvprisen, amerikansk forbrugertillid og Pandora-aktiens kursudvikling. Fra 930 DKK i januar 2024 til 556 DKK i maj 2026, mens sølvprisen mere end tredobledes." />
      ...
      <article className="w-full max-w-[900px] mx-auto px-5 sm:px-8 pb-10 sm:pb-16">
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
            ...
            Pandora-aktien faldet fra ca. 930 DKK til ca. 556 DKK, et fald på ca.
            40%. Der observeres en stærk negativ sammenhæng mellem de to
            (korrelation: {correlation.toFixed(2)} baseret på daglige lukkekurser),
            om end korrelation ikke beviser kausalitet.
          </p>
          <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
            Men sølvprisen er ikke den eneste faktor. USA er Pandoras største
            enkeltmarked med ca. 28% af omsætningen, og den amerikanske
            forbrugertillid er faldet fra 79 i januar 2024 til 44,8 i maj 2026, et
            meget lavt niveau historisk set. For en virksomhed der sælger smykker til forbrugere,
            er begge faktorer relevante.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3 text-gray-600 dark:text-gray-300 text-[15px] leading-relaxed mb-4">
            ...
            <li className="flex gap-2">
              ...
              <span><strong>Industriel efterspørgsel på rekordniveau:</strong> I 2024 nåede industriel sølvefterspørgsel et rekordniveau på 680,5 mio. ounces. Solceller alene stod for ca. 29% af den industrielle efterspørgsel, op fra 11% i 2014. Elbiler og datacentre til AI bidrager også.</span>
            </li>
            <li className="flex gap-2">
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 dark:bg-[#15151a] rounded-2xl border border-gray-100 dark:border-gray-800 p-4 mb-6">
            ...
            <ol className="text-xs text-gray-600 dark:text-gray-400 leading-relaxed space-y-1 list-decimal list-inside">
              ...
              <li><strong>EPS</strong> = nettoindkomst / 75 mio. aktier</li>
          ...
          <div className="bg-gray-50 dark:bg-[#15151a] rounded-2xl border border-gray-100 dark:border-gray-800 p-4 mt-4">
            <p className="text-xs text-gray-500 dark:text-gray-400 leading-relaxed">
              ...
              Skattesats: 24,5%. Aktier: 75 mio. Reference: 21,5% EBIT-margin ved $33/oz blended (2026 guidance).
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
            USA er Pandoras største enkeltmarked med ca. 28% af den samlede
            omsætning i 2025. I Q1 2025 voksede det amerikanske marked med +11%
            like-for-like, men i Q1 2026 var Nordamerika faldet til -2% like-for-like,
            mens den globale LFL-vækst landede på 0%. Den amerikanske opbremsning ser ud til at være en væsentlig
            forklaring på den flade samlede vækst.
            Det falder sammen med et markant fald i den amerikanske forbrugertillid.
          </p>
          <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
          ...
          <div className="grid sm:grid-cols-2 gap-4 mb-6">
            <div className="bg-red-50 dark:bg-red-500/10 rounded-2xl border border-red-100 dark:border-red-500/20 p-5">
              ...
              <ul className="space-y-2 text-[15px] text-gray-700 dark:text-gray-300">
                ...
                <li className="flex gap-2"><span className="text-red-400 mt-0.5">&#x25BC;</span>EBIT-margin guidance sænket fra "mindst 24%" til 21-22%</li>
            ...
            <div className="bg-amber-50 dark:bg-amber-500/10 rounded-2xl border border-amber-100 dark:border-amber-500/20 p-5">
              ...
              <ul className="space-y-2 text-[15px] text-gray-700 dark:text-gray-300">
                ...
                <li className="flex gap-2"><span className="text-amber-500 mt-0.5">&#x25BC;</span>US like-for-like vækst faldet fra +11% til -2%</li>
        ...
        <section className="mb-12">
          ...
          <div className="ml-2">
            <TimelineEvent date="Januar 2024" title="Pandora starter året i 930 DKK" color="#ec4899">
            ...
            <TimelineEvent date="August 2024" title="Pandora når 1.106 DKK" color="#2a9d8f">
              <p>Stærk vækst i USA (+5% LFL) og god Q2-rapport driver aktien op. Sølvprisen er stadig relativt stabil omkring $29/oz.</p>
            </TimelineEvent>
            <TimelineEvent date="December 2024" title="Pandora stiger til 1.233 DKK" color="#2a9d8f">
            ...
            <TimelineEvent date="Marts-april 2025" title="Fald begynder: Told, sølv og sentiment" color="#e63946">
              <p>Aktien falder fra 1.187 DKK til 927 DKK. Consumer Sentiment falder markant til 52-57. US-told på import fra Thailand og Kina annonceres. Sølvprisen stiger til $34/oz.</p>
            </TimelineEvent>
            <TimelineEvent date="August-september 2025" title="Sølv eksploderer over $40/oz" color="#e63946">
              <p>Sølvprisen bryder op fra $36 til $46/oz. Pandora falder til 790 DKK. Q3-rapporten viser 380 bp samlet margintryk fra råvarer, valuta og told. Den 30. september meddeler CEO Alexander Lacik, at han går på pension, og bestyrelsen udpeger CMO Berta de Pablos-Barbier som efterfølger fra generalforsamlingen i marts 2026.</p>
            </TimelineEvent>
            <TimelineEvent date="November-december 2025" title="Sølv over $56-70/oz, Pandora under 700 DKK" color="#e63946">
              <p>Sølvprisen accelererer mod $70/oz. Pandora-aktien falder til 675 DKK. Consumer Sentiment falder til 51-53. EBIT-margin target for 2026 sænkes til 21-22%.</p>
            </TimelineEvent>
            <TimelineEvent date="Januar 2026" title="Sølv rammer all-time high: ~$122/oz intradag" color="#e63946">
              <p>Pandora-aktien falder til 485 DKK, det laveste niveau siden 2022. Sølvprisen rammer sit historiske højdepunkt på ca. $122/oz intradag den 29. januar (daglig lukkekurs ca. $114/oz), før den falder markant tilbage til $76-78/oz.</p>
            </TimelineEvent>
            <TimelineEvent date="1. januar 2026" title="Berta de Pablos-Barbier overtager som CEO" color="#4361ee">
              <p>Den tidligere CMO overtager officielt som CEO den 1. januar 2026, to måneder før planlagt. Alexander Lacik fortsætter som Special Advisor indtil generalforsamlingen den 11. marts. Hun medbringer over 30 års erfaring fra LVMH, Mars Wrigley og Lacoste.</p>
            </TimelineEvent>
            ...
            <table className="w-full text-left">
              ...
              <tbody>
                ...
                <tr className="bg-white dark:bg-[#19191f]">
                  ...
                  <td className="px-4 py-3 text-sm tabular-nums text-gray-900 dark:text-white">39,3 mia. DKK</td>
                </tr>
                <tr className="bg-gray-50/50 dark:bg-[#15151a]">
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
            Pandora-aktien er faldet 40% fra januar 2024 til maj 2026, mens sølvprisen
          ...
          <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
            ...
            Pandora til at sænke sine marginmål fra "mindst 24%" til 21-22%.
          </p>
          <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
            Den amerikanske forbrugertillid er den sekundære, men vigtige faktor.
            Med 28% af omsætningen i USA og et Consumer Sentiment Index på meget lave
            44,8 er efterspørgselssiden under pres. Smykker er en diskretionær
            kategori, og Pandora har allerede set US-væksten falde fra +11% til -2%
            LFL.
          </p>
          <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
          ...
          <div className="bg-gray-50 dark:bg-[#15151a] rounded-2xl border border-gray-100 dark:border-gray-800 p-5 mt-6">
            ...
            <ul className="space-y-1.5 text-[15px] text-gray-600 dark:text-gray-300">
              <li>&#x2022; Sølvprisen: Et vedvarende fald under $60/oz ville lette margintykket markant</li>
        ...
        <footer className="border-t border-gray-100 dark:border-gray-800 pt-6">
          <p className="text-xs text-gray-500 dark:text-gray-400 leading-relaxed text-center">
            ...
            of Michigan Surveys of Consumers, Pandora årsrapport 2025 og Q1 2026-rapport. Historisk afkast er ikke en garanti for fremtidigt afkast.
