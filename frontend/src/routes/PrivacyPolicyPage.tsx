...
const PrivacyPolicyPage: React.FC = () => {
  ...
  const linkClass =
    "text-blue-500 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 underline decoration-blue-500/30 underline-offset-2 transition-colors";
  ...
  return (
    <PageTemplate>
      <div className="max-w-[860px] mx-auto px-5 sm:px-8 py-10 sm:py-16 dark:text-white">
        ...
        <article className="space-y-10 text-[15px] leading-relaxed text-gray-600 dark:text-gray-300">
          <section>
          ...
          <section>
            ...
            <div className="rounded-xl bg-gray-50 dark:bg-gray-800/50 border border-gray-100 dark:border-gray-700/50 px-5 py-4 text-[14px] text-gray-700 dark:text-gray-300">
              <p className="font-semibold text-gray-900 dark:text-white mb-1">Zirium</p>
              <p>Nordre Fasanvej 64, 4. 44</p>
              <p>2000 Frederiksberg</p>
              <p>
                <a href="mailto:zirium.consultancy@gmail.com" className={linkClass}>
          ...
          <section>
            ...
            <ul className="space-y-2 pl-5 list-disc marker:text-blue-500/60">
              <li>
                <strong className="text-gray-900 dark:text-white font-medium">{t("Usage information:")}</strong>{" "}
                {t(
                  "We collect information about how you use our website and app, if you consent to our cookie policy."
                )}
              </li>
              <li>
                <strong className="text-gray-900 dark:text-white font-medium">{t("Device information:")}</strong>{" "}
                {t(
                  "We may collect information about the device you use to access our app, including device type and operating system"
                )}
              </li>
              <li>
                <strong className="text-gray-900 dark:text-white font-medium">{t("Personal information:")}</strong>{" "}
                {t(
          ...
          <section>
            ...
            <ul className="space-y-2 pl-5 list-disc marker:text-blue-500/60">
              <li>{t("To provide and maintain our app's functionality.")}</li>
              <li>
                {t(
                  "To communicate with you, respond to your requests, and provide customer support."
                )}
              </li>
              <li>{t("To improve our app and analyze usage patterns.")}</li>
              <li>{t("To comply with legal and regulatory requirements.")}</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <h3 className="text-base font-semibold text-gray-900 dark:text-white mb-3">{t("Your rights")}</h3>
            <p className="mb-3">
              {t(
            ...
            <p className="mt-5">
              ...
              <a className={linkClass} href="https://www.datatilsynet.dk">
                www.datatilsynet.dk
              </a>
              .
            </p>
