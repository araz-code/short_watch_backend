...
const ShortWatchPage: React.FC = () => {
  ...
  if (isLoading) {
    ...
    content = (
      <div className="overflow-y-auto min-h-[300px] h-[calc(100vh-26rem)] sm:h-[calc(100vh-20rem)]">
        <ul>
          {sort(
            data.filter(
              (item: PricePoint) =>
  ...
  return (
    <div className="h-[calc(100vh-6rem)] sm:h-screen min-h-[620px] overflow-hidden">
      <PageTemplate>
