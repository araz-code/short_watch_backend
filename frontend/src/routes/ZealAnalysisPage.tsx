      ...
      <article className="w-full max-w-[900px] mx-auto px-5 sm:px-8 py-10 sm:py-16">
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
            ...
            35% på en enkelt dag til all-time low på 234,9 DKK med 3,35 mio. handlede aktier.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="ml-2">
            ...
            <TimelineEvent date="6. marts 2026" title="Petrelintide skuffer: -35% på en dag" color="#e63946">
              <p>Fase 2b-resultater viste 10,7% vægttab over 42 uger. Markedet forventede omkring 13-16%. Aktien styrtdykkede til all-time low på 234,9 DKK med 3,35 mio. handlede aktier. CEO Adam Steensberg forsvarede resultatet og kritiserede fokusset på rene kilo fremfor tolerabilitet, hvor petrelintide klarede sig godt (ingen opkast, ingen behandlingsophør).</p>
            </TimelineEvent>
