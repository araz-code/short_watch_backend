...
// Period breakdown
const PERIOD_DATA = [
  { period: "Oct 2023 - Jun 2024", avgPrice: 440, sharesAdded: "7.1M", priceRange: "279-954 DKK" },
  { period: "Jul 2024 - Feb 2025", avgPrice: 806, sharesAdded: "5.1M", priceRange: "700-954 DKK" },
  { period: "Mar 2025 - Feb 2026", avgPrice: 446, sharesAdded: "11.1M", priceRange: "341-700 DKK" },
  { period: "Mar 2026 - May 2026", avgPrice: 286, sharesAdded: "4.3M", priceRange: "235-345 DKK" },
];
      ...
      <article className="w-full max-w-[900px] mx-auto px-5 sm:px-8 pb-10 sm:pb-16">
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3 text-gray-600 dark:text-gray-300 mb-4">
            <li className="flex gap-3">
              ...
              <span><strong>Positions change hands:</strong> Since October 2023, short positions equivalent to
              27.6 million shares have been opened, while 20.4 million have been closed again. Today, only 7.3 million
        ...
        <section className="mb-12">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-300 mb-4">
            ...
            yellow line shows the incremental entry price (~486 DKK). Note how much the price has
          ...
          <div className="bg-white dark:bg-[#19191f] rounded-2xl border border-gray-100 dark:border-gray-800 p-3 sm:p-5" role="img" aria-label="Chart: Short interest vs. stock price for Zealand Pharma with estimated average entry price">
            ...
            <div className="flex items-center gap-4 text-xs text-gray-500 dark:text-gray-300 mt-2 px-2">
              ...
              <span className="flex items-center gap-1.5"><span className="inline-flex items-center gap-[2px]"><span className="w-[4px] h-[2px] bg-[#eab308] inline-block" /><span className="w-[4px] h-[2px] bg-[#eab308] inline-block" /></span>Est. avg. entry (~486 DKK)</span>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
            The most striking period is July 2024 to February 2025. Here, 5.1 million shares were shorted at an
            average price of 806 DKK, when the stock was still near its peak. If a significant portion of these
          ...
          <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
            ...
            an average price of just 286 DKK. These shorts have almost no gain at the current price and risk
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-6">
            ...
            results because they make different assumptions. Here are four methods that range from 342 to
            486 DKK. Together they provide an interval that likely captures the real average price.
          </p>
          ...
          <div className="space-y-4 text-sm text-gray-600 dark:text-gray-300">
            <div className="bg-gray-50 dark:bg-[#15151a] rounded-2xl border border-gray-100 dark:border-gray-800 p-5">
              <h4 className="font-semibold text-gray-900 dark:text-white mb-2">Method 1: Exposure-weighted historical price level (483 DKK)</h4>
            ...
            <div className="bg-gray-50 dark:bg-[#15151a] rounded-2xl border border-gray-100 dark:border-gray-800 p-5">
              <h4 className="font-semibold text-gray-900 dark:text-white mb-2">Method 2: Incremental entry price (486 DKK)</h4>
            ...
            <div className="bg-gray-50 dark:bg-[#15151a] rounded-2xl border border-gray-100 dark:border-gray-800 p-5">
              <h4 className="font-semibold text-gray-900 dark:text-white mb-2">Method 3: Incremental entry price, last 6 months (342 DKK)</h4>
              <p>Same method as method 2, but only over the last 6 months. In this period, short interest has risen from 5.73% to 10.27%, and approximately 7.3 million shares have been added net. By only looking at this period, we better capture the current shorts, since many older positions have likely already been closed. The result of 342 DKK gives the newer shorts a buffer of about 10% at the current price of approximately 311 DKK. This is significantly less than the ~486 DKK from the full dataset.</p>
            </div>
            <div className="bg-gray-50 dark:bg-[#15151a] rounded-2xl border border-gray-100 dark:border-gray-800 p-5">
              <h4 className="font-semibold text-gray-900 dark:text-white mb-2">Method 4: Simple average over 12 months (395 DKK)</h4>
              <p>This method does not use any short data at all. It simply calculates the average closing price for the stock over the last 12 months, regardless of what the short interest was. This gives 395 DKK. The method is easy to understand, but it implicitly assumes that shorts were opened evenly distributed throughout the entire period, which rarely holds in practice.</p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
            ...
            of 633 DKK. If they have held the position unchanged since then, it corresponds to an unrealized
            gain of approximately 51%.
          </p>
          <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
            The historical average entry price for all short positions in Zealand Pharma is around 486 DKK
            (method 2). But if we only look at the last 6 months, where the majority of the current position
            buildup has occurred, the estimate drops to 342 DKK (method 3). With a current price of
            approximately 311 DKK, this corresponds to a gain of only about 10% for the newer shorts, and a
          ...
          <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
            ...
            2024 to February 2025 (at ~806 DKK on average) are potentially sitting on large gains. But the
            most recent shorts from 2026 (at ~286 DKK) are close to break-even and risk losses if the stock
