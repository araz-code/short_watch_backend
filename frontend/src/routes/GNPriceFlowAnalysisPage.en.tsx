...
function FlowTooltip({ active, payload }: TooltipContentProps<ValueType, NameType>) {
  ...
  return (
    <div className="rounded-xl shadow-lg px-4 py-3 bg-white/95 dark:bg-[#19191f]/95 backdrop-blur-xs border border-gray-100 dark:border-gray-700 text-sm">
      ...
      <p className="text-center text-red-500 tabular-nums">Shorted: {fmtMio(d.shorted)}</p>
      <p className="text-center text-green-600 dark:text-green-400 tabular-nums">Covered: {fmtMio(d.covered)}</p>
      <p className="text-center font-bold tabular-nums text-gray-900 dark:text-white">Net: {d.net > 0 ? "+" : ""}{fmtMio(d.net)}</p>
    </div>
  );
}
...
const GNPriceFlowAnalysisPage: React.FC = () => {
  ...
  return (
    <PageTemplate>
      <title>Zirium | GN Store Nord (GN) - Price Flow</title>
      <meta name="description" content="How to read the price flow on Zirium. Using GN Store Nord as a case, we show at which prices the short sellers opened and covered their positions." />
      <meta property="og:title" content="How to read the price flow: Where have the shorts traded GN?" />
      <meta property="og:description" content="Using GN Store Nord as a case, we show at which prices the short sellers opened and covered their positions, and how to read the price flow yourself." />
      <meta property="og:type" content="article" />
      <meta property="og:url" content="https://www.zirium.dk/analyse/gn/flow/2026-06-28" />
      <meta property="og:image" content="https://www.zirium.dk/og-images/gn-flow-2026-06-28-en.png" />
      <meta property="og:image:width" content="1200" />
      <meta property="og:image:height" content="630" />
      <meta property="og:image:type" content="image/png" />
      <meta property="og:site_name" content="Zirium" />
      <meta name="twitter:card" content="summary_large_image" />
      <meta name="twitter:title" content="How to read the price flow: Where have the shorts traded GN?" />
      <meta name="twitter:description" content="Using GN Store Nord as a case, we show at which prices the short sellers opened and covered their positions, and how to read the price flow yourself." />
      <meta name="twitter:image" content="https://www.zirium.dk/og-images/gn-flow-2026-06-28-en.png" />
      <link rel="canonical" href="https://www.zirium.dk/analyse/gn/flow/2026-06-28" />
      <script type="application/ld+json">{JSON.stringify({
        "@context": "https://schema.org",
        "@type": "Article",
        "headline": "How to read the price flow: Where have the shorts traded GN?",
        "description": "Using GN Store Nord as a case, we show at which prices the short sellers opened and covered their positions, and how to read the price flow yourself.",
      ...
      <article className="w-full max-w-[900px] mx-auto px-5 sm:px-8 pb-10 sm:pb-16">
        ...
        <header className="mb-10 mt-4">
          <p className="text-lg text-gray-700 dark:text-gray-200 font-medium mb-4">Analysis by Araz Bayat Makoo (Zirium) - June 28, 2026</p>
          <h1 className="text-3xl sm:text-4xl font-bold tracking-tight text-gray-900 dark:text-white mb-3 leading-tight">
            How to read the price flow: Where have the shorts traded GN?
          </h1>
          <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
            GN Store Nord (GN)
          </p>
          <p className="text-gray-600 dark:text-gray-300 mt-3 leading-relaxed">
            The price flow is a tab on each stock's detail page that distributes every reported
            change in short interest across price levels, so you can see at which prices shorts were
            opened and covered. This analysis uses GN Store Nord as a case and shows, step by step, how
            to read the numbers, what they can tell you, and where the method's limits lie.
          </p>
        </header>

        {/* ── KPIs ── */}
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-12">
          <KPI value="9.85%" label="Short interest (June 26)" highlight tone="blue" />
          <KPI value="87.30 DKK" label="Latest close (June 26)" />
          <KPI value="62.9M" label="Shares shorted since Nov 2023" highlight tone="red" />
          <KPI value="57.4M" label="Shares covered since Nov 2023" highlight tone="green" />
        </div>

        {/* ── 1. Hvad er prisstrømmen ── */}
        <section className="mb-12">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-4">1. What is the price flow?</h2>
          <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
            The Danish FSA's data shows the total short interest in a stock each day, but not at
            which prices the positions were traded. The price flow is an estimate that fills that gap.
            The calculation has three steps:
          </p>
          <ul className="space-y-3 text-gray-600 dark:text-gray-300 mb-4">
            <li className="flex gap-3">
              <span className="text-blue-500 font-bold shrink-0">1.</span>
              <span><strong>Day-to-day changes:</strong> Each day the short interest is compared with the day before.
              If it rises, new shorts were opened on net. If it falls, shorts were covered on net. The
              change in percentage points is converted to shares. For GN, 1 percentage point equals about
              1.46 million shares.</span>
            </li>
            <li className="flex gap-3">
              <span className="text-blue-500 font-bold shrink-0">2.</span>
              <span><strong>The price is set to the previous trading day:</strong> Changes are typically reported the
              day after the trade (T+1). A change that becomes visible on Tuesday therefore most likely
              reflects a trade on Monday, and it is assigned the average of Monday's high, low and close.</span>
            </li>
            <li className="flex gap-3">
              <span className="text-blue-500 font-bold shrink-0">3.</span>
              <span><strong>The shares are grouped into price bands:</strong> All changes are collected into 2%-wide
              price bands. Red means opened shorts, green means covered shorts, and the net column shows
              the direction in each band.</span>
            </li>
          </ul>
          <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
            You'll find the price flow on each stock's detail page under the Price Flow tab, both on
            zirium.dk and in the app. The result resembles what technical analysis calls a volume profile,
            but here it is purely the short activity that is distributed across price levels. You can open
            GN's price flow directly <a href="https://www.zirium.dk/short-watch-details?code=DK0010272632&tab=flow" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:text-blue-700 underline">here</a>.
          </p>
        </section>

        {/* ── 2. Short-interesse vs. aktiekurs ── */}
        <section className="mb-12">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-2">2. The context: Short interest vs. share price</h2>
          <p className="text-gray-500 dark:text-gray-300 mb-4">
            History since November 2023. Blue = short interest, purple = closing price. These are the
            two curves the price flow combines into one picture.
          </p>
          <div className="bg-white dark:bg-[#19191f] rounded-2xl border border-gray-100 dark:border-gray-800 p-3 sm:p-5" role="img" aria-label="Chart: Short interest vs. share price for GN Store Nord since November 2023">
          ...
          <p className="text-gray-600 dark:text-gray-300 leading-relaxed mt-4">
            GN is a good example because, over the period shown, the stock has been through the entire
            spectrum: A peak of 224 DKK in June 2024 (the stock has been higher before 2023), a low of
            82.56 DKK in April 2025, and a jump on the Amplifon news in March 2026. Meanwhile, short
            interest has gone from 6% to over 13% and back down to 9.85%. Since November 2023, a gross
            62.9 million shares have been shorted and 57.4 million covered. That is about 4.4 times the
            current short position of roughly 14.3 million shares, so there has been plenty of activity to
            distribute across the price bands.
          </p>
        </section>

        {/* ── 3. Hele historikken ── */}
        <section className="mb-12">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-2">3. The whole history in one picture</h2>
          <p className="text-gray-500 dark:text-gray-300 mb-4">
            Net flow per 2%-wide price band since November 2023. Red = net opened shorts, green = net
            covered shorts. The dashed line marks the current price.
          </p>
          <div className="bg-white dark:bg-[#19191f] rounded-2xl border border-gray-100 dark:border-gray-800 p-3 sm:p-5" role="img" aria-label="Chart: Net price flow per band for GN Store Nord since November 2023">
            <ResponsiveContainer width="100%" height={chartHeight}>
              <ComposedChart data={FLOW_FULL} margin={{ top: 5, right: 5, left: 0, bottom: 5 }}>
                ...
                <YAxis tick={{ fontSize: 10, fill: tickColor }} tickFormatter={(v) => `${v}`} label={{ value: "million shares", angle: -90, position: "insideLeft", fontSize: 10, fill: tickColor }} />
            ...
            <div className="flex items-center gap-4 text-xs text-gray-500 dark:text-gray-300 mt-2 px-2">
              ...
              <span className="flex items-center gap-1.5"><span className="inline-flex items-center gap-[2px]"><span className="w-[4px] h-[2px] bg-[#eab308] inline-block" /><span className="w-[4px] h-[2px] bg-[#eab308] inline-block" /></span>Price today (87.30 DKK)</span>
            </div>
          </div>
          <p className="text-gray-600 dark:text-gray-300 leading-relaxed mt-4 mb-4">
            The largest red band sits at 107.70-109.85 DKK, where 2.55 million shares were opened on
            net. There are also large red bands higher up, at 156.89-160.03 (net 1.65M), 160.03-163.23
            (1.24M) and 163.23-166.50 DKK (1.91M), which were mainly opened in 2024 when the stock traded
            above 150 DKK.
          </p>
          <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
            The largest green bands, by contrast, sit lower: 97.54-99.50 DKK (net 2.08 million shares
            covered), 99.50-101.49 DKK (net 1.02M), 147.84-150.80 DKK (net 1.16M) and 150.80-153.82 DKK
            (net 1.05M). The pattern, then, is that shorts were opened on net at high prices and covered at
            lower ones: Above 100 DKK, about 7.2 million shares were opened on net, while below 100 about
            1.6 million were covered on net. Note, however, one red band right down at 91.92-93.76 DKK (net
            1.3M opened), the first sign that some shorts are opening again at the low levels.
          </p>
          <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
            What can you use this for? If the positions opened at 108 and 157-166 DKK are still open,
            they are sitting on solid gains at the current price of about 87 DKK. These are shorts with a
            large buffer, not forced to react to minor price swings. The heavy covering at 97-101 DKK was
            likewise profit-taking, not panic. So the still-high short interest of over 9% is not a coiled
            spring of distressed positions: Most of the remaining shorts were opened higher up and are in
            profit, so they can choose for themselves when to cover.
          </p>
        </section>

        {/* ── 4. Amplifon-casen ── */}
        <section className="mb-12">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-4">4. The case: The Amplifon days show how to read the flow</h2>
          <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
            On March 16, 2026, GN announced the sale of its hearing-aid division (GN Hearing) to
            Amplifon for DKK 17 billion. The stock jumped sharply: It reached 123.75 DKK intraday and
            closed at 105.30 after a very volatile session. Over the following two days, short interest
            fell from 13.04% (the highest in the dataset) to 10.85%, that is 2.19 percentage points or
            about 3.2 million shares that the shorts covered.
          </p>
          <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
            The case also shows why the price flow uses the day's average price, the mean of high, low
            and close, rather than the closing price. On March 16, the close was 105.30, but the average
            price was 111.43, because the stock had been all the way up at 123.75 during the day. The
            single largest covering in the whole dataset, 2.45 million shares on March 17, is therefore
            placed at about 111 DKK, not at 105. On a calm day the two prices sit close together, but on a
            wild day like this they differ by a good 6 DKK, a reminder that the placement is an estimate,
            not an exact trading price.
          </p>
          <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
            Note that this covering almost disappears in the chart in section 3, which shows only the
            net: At 111 DKK, roughly as much was shorted at other times, so the net comes out near zero
            (caveat 1 in practice). In the app's list, where shorted and covered are shown separately, you
            can see it, with the March date next to it.
          </p>
          <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
            The point is general: Big swings in the flow almost always have a concrete cause, an
            earnings report, a profit warning or, as here, a divestment. The date column in the app shows
            when each band was last active, so you can tie the flow to specific news.
          </p>
        </section>

        {/* ── 5. Seneste 3 måneder ── */}
        <section className="mb-12">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-4">5. The last 3 months: Mild covering and new shorting around 100 DKK</h2>
          <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
            The period buttons on the detail page also filter the price flow. That matters, because the
            full picture above mixes two-year-old trades with last week's. If you select only the last 3
            months, the table looks like this:
          </p>

          <div className="overflow-x-auto rounded-2xl border border-gray-100 dark:border-gray-800 mb-6">
            <table className="w-full text-left">
              <caption className="sr-only">Price flow for GN Store Nord over the last 3 months</caption>
              <thead>
                <tr className="bg-blue-500 text-white">
                  <th scope="col" className="px-4 py-3 text-xs font-semibold uppercase tracking-wide">Price band (DKK)</th>
                  <th scope="col" className="px-4 py-3 text-xs font-semibold uppercase tracking-wide">Shorted</th>
                  <th scope="col" className="px-4 py-3 text-xs font-semibold uppercase tracking-wide">Covered</th>
                  <th scope="col" className="px-4 py-3 text-xs font-semibold uppercase tracking-wide">Net</th>
                </tr>
              </thead>
              <tbody>
                {FLOW_3M.map((b, i) => (
          ...
          <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
            Since the end of March, about 1.7 million shares have been covered on net, and short
            interest has fallen from 11.03% to 9.85%. On a gross basis, 7.0 million shares were covered
            and 5.2 million opened. The covering is heavily concentrated at 97-99 DKK, where nearly 3 million
            shares were covered on net, as the stock traded there in April and May. Note that the big
            Amplifon days from March have now dropped out of the 3-month window, so the picture here is
            cleared of the one-off jump and shows what the shorts have done since.
          </p>
          <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
            More interesting are the red bands: While the shorts covered at 98, they simultaneously
            opened new positions just above, at 99-103 DKK (a good 1.7 million shares combined), and added
            a little more spread out at 88-95 DKK. So it is less pure profit-taking and more a reshuffling
            of positions around 100 DKK. In June, short interest has swung between about 9.5% and 10.2% and
            now sits at 9.85%, so the pressure has not really eased.
          </p>
        </section>

        {/* ── 6. Sådan bruger du fanen ── */}
        <section className="mb-12">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-4">6. How to use the tab in practice</h2>
          <div className="space-y-4 text-gray-600 dark:text-gray-300">
            <div className="bg-gray-50 dark:bg-[#15151a] rounded-2xl border border-gray-100 dark:border-gray-800 p-5">
              <h4 className="font-semibold text-gray-900 dark:text-white mb-2">Use the period buttons actively</h4>
              <p>The full picture shows where the historical positions were built, while 1M/3M shows what the shorts are doing right now. As in the GN example, the two can tell very different stories: Historical net shorting at 108 DKK, but mostly covering in recent months.</p>
            </div>
            <div className="bg-gray-50 dark:bg-[#15151a] rounded-2xl border border-gray-100 dark:border-gray-800 p-5">
              <h4 className="font-semibold text-gray-900 dark:text-white mb-2">Watch the bar length and the dates</h4>
              <p>Behind the numbers in each row is a bar whose length shows how much was shorted or covered in the band, scaled to the largest band. Below the numbers is the date when the band was last shorted or covered, respectively. The two are independent: The bar length is the total amount, which may have built up over a long time, while the date only tells you when the band was last active, not that the entire amount is new.</p>
            </div>
            <div className="bg-gray-50 dark:bg-[#15151a] rounded-2xl border border-gray-100 dark:border-gray-800 p-5">
              <h4 className="font-semibold text-gray-900 dark:text-white mb-2">Compare with the current price</h4>
              <p>If the price is below the large red bands, the shorts are in profit overall and can afford to be patient, provided they have not already covered. If the price is above them, they are under pressure, and a further rise can force them to cover. For GN, the large red bands sit at 108 and 157-166 DKK, well above the current price of about 87 DKK, but whether those positions are still open, the price flow does not show.</p>
            </div>
            <div className="bg-gray-50 dark:bg-[#15151a] rounded-2xl border border-gray-100 dark:border-gray-800 p-5">
              <h4 className="font-semibold text-gray-900 dark:text-white mb-2">Tie big bands to events</h4>
              <p>Big swings in the flow almost always have a concrete cause: An earnings report, a profit warning or, as in GN's case, a divestment. Use the dates to find the event before you read into the pattern.</p>
            </div>
          </div>
        </section>
        ...
        {/* ── 7. Forbehold ── */}
        <section className="mb-12">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-4">7. Caveats: What the price flow cannot do</h2>
          <ul className="space-y-3 text-gray-600 dark:text-gray-300 mb-4">
            <li className="flex gap-3">
              <span className="text-blue-500 font-bold shrink-0">1.</span>
              <span><strong>It only sees net changes:</strong> If one fund covers 500,000 shares and another opens
              500,000 on the same day, the flow shows zero. The real activity is always greater than what
              can be read off.</span>
            </li>
            <li className="flex gap-3">
              <span className="text-blue-500 font-bold shrink-0">2.</span>
              <span><strong>The price is an assumption:</strong> We assign the change to the previous trading day's
              average price (high, low, close) because of T+1 reporting. We do not know the actual intraday
              trading price, and on large intraday swings, as on the Amplifon day, the deviation can be
              significant.</span>
            </li>
            <li className="flex gap-3">
              <span className="text-blue-500 font-bold shrink-0">3.</span>
              <span><strong>It does not distinguish between actors:</strong> The flow is the sum of the reported
              shorts, both the publicly disclosed positions above 0.50% and the anonymous ones between
              0.1% and 0.50%. A red band tells you that someone shorted at that level, not who, nor whether
              they still hold the position. With gross activity at 4.4 times the current position, many of
              the trades shown may long since have been offset by later trades.</span>
            </li>
            <li className="flex gap-3">
              <span className="text-blue-500 font-bold shrink-0">4.</span>
              <span><strong>The bands are estimates:</strong> 2%-wide price bands are chosen as a compromise between
              detail and noise. The numbers should be read as levels and orders of magnitude, not as
              precise trading prices.</span>
            </li>
            <li className="flex gap-3">
              <span className="text-blue-500 font-bold shrink-0">5.</span>
              <span><strong>The bands shift with the period:</strong> The boundaries are computed from the lowest
              price in the window shown, so the same price levels can get slightly different band edges in,
              say, the 3M and full views. It is therefore best to compare the bands within one period at a time.</span>
            </li>
            <li className="flex gap-3">
              <span className="text-blue-500 font-bold shrink-0">6.</span>
              <span><strong>Positions below 0.1% are not included:</strong> Net short positions only have to be
              reported from 0.1% (and disclosed by name from 0.5%). Anything below 0.1% is reported
              nowhere, so the real short interest can be slightly higher than what we show.</span>
            </li>
          </ul>
        </section>
        ...
        {/* ── 8. Konklusion ── */}
        <section className="mb-12">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-4">8. Conclusion</h2>
          <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
            The price flow answers the question that raw short interest cannot: Not just how much has
            been shorted, but where. For GN, it shows that the shorting we can track since November 2023 was
            mainly built at 108 DKK and up at 157-166 DKK, while below 100 DKK there has been net covering.
            At the current price of about 87 DKK, those positions are therefore in profit, provided they
            are still open, since the price flow does not show whether they have already been closed higher
            up. And although the last 3 months have on the whole been dominated by profit-taking, new net
            shorting has at the same time appeared around 100 DKK and scattered across the low bands.
          </p>
          <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
            And that is exactly the most interesting thing to watch from here: The color of the bands
            around 87-95 DKK, where the price sits now. In the 3M view, a little new net shorting has
            already appeared here. If those bands keep being red, the shorts are rebuilding positions at
            the low levels, and then the story of GN as one of the most shorted Danish stocks is far from
            over. If they turn green, covering is under way again. The price flow gives you the answer
            continuously, updated every day on the stock's detail page.
          </p>
        </section>
        ...
        <footer className="border-t border-gray-100 dark:border-gray-800 pt-6">
          <p className="text-xs text-gray-500 dark:text-gray-400 leading-relaxed text-center">
            ...
            constitute investment advice. The price flow is an estimate based on publicly available data
            from the Danish FSA and market prices. The actual trading prices may differ significantly.
            Always do your own analysis and seek professional advice before trading.
          </p>
          <p className="text-xs text-gray-500 dark:text-gray-400 text-center mt-3">
            Copyright Zirium  |  June 28, 2026
          </p>
        </footer>
      </article>
    </PageTemplate>
