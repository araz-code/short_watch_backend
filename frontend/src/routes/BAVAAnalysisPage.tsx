...
const BAVAAnalysisPage: React.FC = () => {
  ...
  return (
    <PageTemplate>
      ...
      <meta property="og:image" content="https://www.zirium.dk/og-images/bava-2026-05-17.png" />
      ...
      <meta name="twitter:image" content="https://www.zirium.dk/og-images/bava-2026-05-17.png" />
      ...
      <article className="w-full max-w-[900px] mx-auto px-5 sm:px-8 pb-10 sm:pb-16">
        ...
        <header className="mb-10 mt-4">
          <p className="text-lg text-gray-700 dark:text-gray-200 font-medium mb-4">Analyse lavet af Araz Bayat Makoo (Zirium) - 17. maj 2026</p>
