...
const LargeShortSellingRow: React.FC<LargestShortSelling & { isEven: boolean }> = (props) => {
  ...
  return (
    ...
    >
      <div className={`mx-2 my-1 px-4 py-2 rounded-lg flex items-center justify-between shadow-xs hover:shadow-md hover:-translate-y-px transition-all duration-200 text-sm dark:text-white border border-gray-100 dark:border-gray-800 ${isEven ? "bg-white dark:bg-[#19191f]" : "bg-gray-50 dark:bg-[#131318]"}`}>
