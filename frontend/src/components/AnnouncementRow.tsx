...
const AnnouncementRow: React.FC<Announcement> = (props) => {
  ...
  return (
    ...
    >
      <div className="mx-2 my-1.5 px-4 py-2.5 rounded-lg bg-white dark:bg-[#19191f] shadow-xs hover:shadow-md hover:-translate-y-px transition-all duration-200 text-sm dark:text-white border border-gray-100 dark:border-gray-800">
