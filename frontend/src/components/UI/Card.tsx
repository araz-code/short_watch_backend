...
const Card: React.FC<{
  ...
  return (
    <figure className="p-4 max-w-sm group">
      <div className="flex flex-col p-6 h-full rounded-2xl bg-white dark:bg-[#19191f] border border-gray-200 dark:border-gray-700 shadow-xs hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
