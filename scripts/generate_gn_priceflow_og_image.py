"""Generates the OG image for the GN Store Nord price-flow (prisstrøm) analysis
in the same style as the other analyses. Danish only."""
...
ACCENT = (245, 158, 11)      # amber-500 (#F59E0B, matches the GN card accent)
ACCENT_DARK = (217, 119, 6)  # amber-600 (#D97706) darker end of gradient
WHITE = (255, 255, 255)
SUBTLE = (180, 188, 210)
