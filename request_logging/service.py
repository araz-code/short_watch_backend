...
def today_visit_buckets() -> dict:
    ...
    help_short_watch, help_details, avg_price_info = set(), set(), set()
    ...
    for entry in queryset:
        ...
        if "/stats/visit/help-details" in url:
            help_details.add(ip)
        if "/stats/visit/avg-price-info" in url:
            avg_price_info.add(ip)
    ...
    return {
        ...
        'help_short_watch': help_short_watch, 'help_details': help_details, 'avg_price_info': avg_price_info,
