...
urlpatterns = [
    ...
    path('chart/requestlogging/requests-today/', views.get_request_per_hour_chart_today),
    path('chart/requestlogging/requests-yesterday/', views.get_request_per_hour_chart_yesterday),
]
